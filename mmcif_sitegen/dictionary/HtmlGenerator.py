...
class HtmlGenerator(object):
    ...
    def __makeDirs(self, subDirPath, htmlTopPath, purge=True):
        ...
        try:
            ...
            logger.error("HtmlGenerator.__makeDirs() failed for %s and %s\n" % (subDirPath, htmlTopPath))
    ...
    def writeHtmlFile(self, contentObjName, title, subTitle, contentType, htmlContentList, navBarContentType='default'):
        ...
        try:
            ...
            logger.debug("HtmlGenerator.writeHtmlFile() writing file %s\n" % (filePath))
            ...
            logger.error("HtmlGenerator.writeHtmlFile() failed for %s\n" % (filePath))
            logger.exception("Failing with %s" % str(e))
        return False
